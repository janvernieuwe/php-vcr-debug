...
class StreamProcessor
{
    ...
    public function stream_open($path, $mode, $options, &$openedPath)
    {
        ...
        if ($options & self::STREAM_OPEN_FOR_INCLUDE) {
            ...
            foreach (self::$codeTransformers as $transformer) {
                $content = $transformer->transformCode($content);
            }
...
class SampleFilter extends \PHP_User_Filter
{
    ...
    {
        return str_replace('curl_init()', '/*some padding*/curl_init()/*more padding*/', $code);
    }
}
